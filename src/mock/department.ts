  ...
  Mock.mock(/\/api\/department\/list/, 'get', (options: any) => {
    ...
    for (let i = 0; i < pageSize; i++) {
      list.push({
        ...
        name:
          Random.pick(['华东分部', '华南分部', '华北分部', '西部大区', '总部']) +
          '-' +
          Random.pick(['研发部', '技术部', '财务部', '市场部', '人力资源部', '产品部', '测试部']),

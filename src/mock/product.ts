      ...
      data: {
        list: [
          ...
          },
          {
            ...
            status: '启用',
            description: '',
            children: [{ id: 21, name: '版本号', type: '版本', status: '启用', description: '', children: [] }],
          },
        ],
        total: 2,
      },
  ...
  Mock.mock(/\/api\/license-template\/detail/, 'get', () => {
    return {
      ...
      data: {
        ...
        templateCode: 'TPL' + String(Random.integer(1000, 9999)),
        templateName:
          Random.pick(['数据分析平台', '智能报表系统']) + '-' + Random.pick(['试用版', '标准版', '专业版', '企业版']),

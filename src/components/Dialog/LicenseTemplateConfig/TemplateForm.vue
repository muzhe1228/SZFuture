  ...
  >
    ...
    >
      ...
      <el-form-item label="*产品模块" prop="productModuleId">
        <el-select v-model="form.productModuleId" placeholder="请选择产品模块" style="width: 400px">
          <el-option
            v-for="option in productModuleOptions"
            :key="option.value"
            :label="option.label"
            :value="option.value"
          />
      ...
      <el-form-item label="*许可类型" prop="licenseType">
        <el-select v-model="form.licenseType" placeholder="请选择许可类型" style="width: 200px">
      ...
      <el-form-item label="浮动许可" prop="floatingLicense">
        <el-switch v-model="form.floatingLicense" active-text="是" inactive-text="否" inline-prompt />
      </el-form-item>

      <el-form-item required label="激活码数量" v-if="form.floatingLicense" prop="floatingLicenseCount">
        <el-input
          v-model.number="form.floatingLicenseCount"
          placeholder="请输入许可关联激活码数量"
          type="number"
          min="1"
          style="width: 200px"
        />
...
<script setup lang="ts">
  ...
  const { form, formRef, resetForm, validateForm, setFormValue } = useForm<TemplateForm>(defaultValues, rules)
    ...
    (newTemplate) => {
      if (newTemplate) {
        setFormValue({
          ...
          productModuleId: newTemplate.productModuleId || 0,

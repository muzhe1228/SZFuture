<template>
  <BaseDialog :model-value="modelValue" :title="isEditMode ? '修改订单' : '新增订单'" width="720px"
    :close-on-click-modal="false" :confirm-loading="submitLoading"
    @update:model-value="(val) => emit('update:modelValue', val)" @confirm="handleSubmit" @cancel="handleCancel"
    @close="resetModal">
    <el-form ref="orderFormRef" :model="orderForm" :rules="orderFormRules" label-width="110px" label-position="right"
      class="order-form">
      <el-row :gutter="20">
        <el-col :span="12">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="授权数量" prop="authCount">
            <el-input-number v-model="orderForm.authCount" :min="1" :max="9999" :controls="false" align="left"
              style="width: 100%" />
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="产品名称" prop="productName">
            <el-select v-model="orderForm.productName" placeholder="请选择" style="width: 100%"
        ...
        <el-col :span="12">
          <el-form-item label="产品版本" prop="productVersion">
            <el-select v-model="orderForm.productVersion" placeholder="请先选择产品名称" style="width: 100%"
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="许可模版" prop="licenseTemplate">
            <el-select v-model="orderForm.licenseTemplate" placeholder="请选择" style="width: 100%"
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="授权起始" prop="authStartDate">
            <el-date-picker v-model="orderForm.authStartDate" type="datetime" placeholder="选择日期时间"
              value-format="YYYY-MM-DD HH:mm:ss" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="授权结束" prop="authEndDate">
            <el-date-picker v-model="orderForm.authEndDate" type="datetime" placeholder="选择日期时间"
              value-format="YYYY-MM-DD HH:mm:ss" style="width: 100%" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label="功能权限" prop="permissions">
        <div class="permission-grid">
          <div v-for="perm in permissionsList" :key="perm.name" class="permission-item">
            ...
            <el-input-number v-model="perm.limit" :min="0" :max="9999" :disabled="!perm.checked" :controls="false"
              align="left" size="small" style="width: 90px" />
          </div>
        </div>
      </el-form-item>
      <el-form-item label="订单备注" prop="remarks">
        <el-input v-model="orderForm.remarks" type="textarea" :rows="2" placeholder="请输入订单备注" />
      </el-form-item>
    </el-form>
  </BaseDialog>
</template>

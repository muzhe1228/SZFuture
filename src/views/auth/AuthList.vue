<template>
  <div class="auth-list">
    ...
    <UnfreezeModal
      ...
      :auth="currentAuth"
      @unfreeze="handleUnfreezeSubmit"
    />

    <!-- 4. 授权延期 Modal -->
    <ExtendModal
      v-model="extendModalVisible"
      @extend="handleExtendSubmit"
    />

    <!-- 5. 授权作废 Modal -->
    <VoidModal
      v-model="voidModalVisible"
      @void="handleVoidSubmit"
    />

    <!-- 7. 授权激活 Modal -->
    <ActivateModal
      v-model="activateModalVisible"
      :auth-no="currentAuth?.authNo"
      @activate="handleActivateSubmit"
    />
  </div>
</template>
...
import FreezeModal from '@/components/Dialog/AuthList/FreezeModal.vue'
import UnfreezeModal from '@/components/Dialog/AuthList/UnfreezeModal.vue'
import ExtendModal from '@/components/Dialog/AuthList/ExtendModal.vue'
import VoidModal from '@/components/Dialog/AuthList/VoidModal.vue'

import ActivateModal from '@/components/Dialog/AuthList/ActivateModal.vue'

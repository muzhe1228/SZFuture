<template>
  <div class="role-management">
    ...
    <BaseTablePage :search-fields="searchFields" :columns="columns" :actions="tableActions" :fetch-data="fetchData"
      title="角色管理" storage-key="role-management" :show-column-settings="true" :show-selection="true"
      ...
      <template #extra-actions>
        <el-button type="primary" link @click="handleAdd" :icon="Plus">新增角色</el-button>
        <el-button type="danger" link plain @click="() => handleBatchDelete(selectedRoles)"
          :disabled="selectedRoles.length === 0">删除角色</el-button>
      </template>
    </BaseTablePage>
